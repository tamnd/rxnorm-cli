...
```
rxnorm <command> [arguments] [flags]
```

Run `rxnorm <command> --help` for the full flag list on any command. This
...
a row here per operation you declare in `rxnorm/domain.go`.
